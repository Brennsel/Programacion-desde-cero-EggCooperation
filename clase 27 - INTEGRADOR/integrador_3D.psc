Algoritmo integrador_3D
	...
	diagonal3D1 = calculadora(0, 2, 0)*calculadora(1, 1,1)*calculadora(2, 0, 2) //D1=Ccontradiagonal
	diagonal3D2 = calculadora(0, 0, 0)*calculadora(1, 1,1)*calculadora(2, 2, 2) //D2=DiagonalPrincipal

	Escribir "Diagonal 3D1: " diagonal3D1
	Escribir "Diagonal 3D2: " diagonal3D2
